...
<script type="text/JavaScript">
	function goPopup(){
		var pop = window.open("./authority.bill","pop","width=400,height=300, scrollbars=yes, resizable=yes"); 
	}
	function textPopup(){
...
<div class="page">
		...
		<nav>
			<ul>
				...
				<li><a href="./MyProductList.bill?userseq=<jsp:getProperty property="userseq" name="userdata"/>"><input type="button" value="등록 상품 목록"></a></li>
				<li><a href="./MyborrowList.bill?userseq=<jsp:getProperty property="userseq" name="userdata"/>"><input type="button" value="대여 상품 목록" style="background-color: brown; color:white;"></a></li>
		...
		<c:forEach items="${MyBorrowList}" var="dto">
		<tr>
