...
<script type="text/JavaScript">
	function goPopup(){
		var pop = window.open("./authority.bill","pop","width=400,height=300, scrollbars=yes, resizable=no"); 
	}
	function textPopup(){
...
<div class="page">
		...
		<nav>
			<ul>
				...
				<li><a href="./MyInterestList.bill?userseq=<jsp:getProperty property="userseq" name="userdata"/>"><input type="button" value="관심 상품 목록" style="background-color: brown; color:white;"></a></li>
